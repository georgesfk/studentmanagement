...
public class EtudiantService {
    ...
    @Autowired
    private NoteDAO noteDAO;  // Injecting NoteDAO
    ...
    public Etudiant consulterEtudiant(int id) {
        return etudiantDAO.findById(id).orElseThrow(() -> new IllegalArgumentException("Etudiant introuvable"));
    }

    public List<Note> consulterNotes(int etudiantId) {
        // Now noteDAO is available for use
